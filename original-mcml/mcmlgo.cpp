...
std::ofstream directions("directions_original.txt");
					  ...
					  InputStruct  * In_Ptr)
{
  ...
  // disable sleft, should have no statistical effect:
						 ...
						 OutStruct    *  Out_Ptr)
{
  ...
  directions << std::setw(15) << In_Ptr->bounceCount << std::setw(15) << Photon_Ptr->ux << std::setw(15) << Photon_Ptr->uy << std::setw(15) << Photon_Ptr->uz;
  directions << std::setw(15) << Photon_Ptr->layer - 1 << std::setw(15) << Photon_Ptr->x << std::setw(15) << Photon_Ptr->y << std::setw(15) << Photon_Ptr->z << std::endl;  
}
